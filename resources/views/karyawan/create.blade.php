<x-layout>
    <x-slot:title>Create New Karyawan</x-slot:title>
...
-->
    ...
    <div class="isolate -space-y-px rounded-md shadow-sm w-1/4">
        <div class="relative rounded-md rounded-b-none px-3 pb-1.5 pt-2.5 ring-1 ring-inset ring-gray-300 focus-within:z-10 focus-within:ring-2 focus-within:ring-indigo-600">
            ...
            <input type="text" name="nama" id="nama" class="block w-full border-0 p-0 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" value="{{old('nama')}}" placeholder="Please input Name">
        </div>
        @error('nama')
        ...
        <div class="relative rounded-md rounded-t-none px-3 pb-1.5 pt-2.5 ring-1 ring-inset ring-gray-300 focus-within:z-10 focus-within:ring-2 focus-within:ring-indigo-600">
            ...
            <input type="text" name="nik" id="nik" class="block w-full border-0 p-0 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="Input NIK" value="{{old('nik')}}">
        </div>
        @error('nik')
        <div class="text-red-700">{!! $message !!}</div>
        @enderror
        <div class="relative rounded-md rounded-t-none px-3 pb-1.5 pt-2.5 ring-1 ring-inset ring-gray-300 focus-within:z-10 focus-within:ring-2 focus-within:ring-indigo-600">
            ...
            <input type="text" name="alamat" id="alamat" class="block w-full border-0 p-0 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="Head of Tomfoolery">
        </div>
        @error('alamat')
        <div class="text-red-700">{{$message}}</div>
        @enderror
    </div>
        <input type="submit" value="Submit" class="rounded bg-indigo-600 px-2 py-1 text-xs font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
